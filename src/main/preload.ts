...
contextBridge.exposeInMainWorld('clawdia', {
  ...
  terminal: {
    ...
    spawn: (_id: string, _opts?: any) => Promise.resolve(null),
    write: (_id: string, _data: string, _meta?: any) => Promise.resolve(false),
    resize: (_id: string, _cols: number, _rows: number) => Promise.resolve(false),
    kill: (_id: string) => Promise.resolve(false),
    list: () => Promise.resolve([]),
    getSnapshot: (_id: string) => Promise.resolve(null),
    acquire: (_id: string, _owner: string, _meta?: any) => Promise.resolve(false),
    release: (_id: string) => Promise.resolve(false),
    requestTakeover: (_id: string, _requester: string) => Promise.resolve(false),
    ...
    onData: (_cb: (payload: { id: string; data: string }) => void) => noop,
    onExit: (_cb: (payload: { id: string; code: number; signal?: number }) => void) => noop,
    onEvent: (_cb: (payload: any) => void) => noop,
    onSessionState: (_cb: (payload: any) => void) => noop,
  },
